...
import anpr.system.program.OperatorMenu;

/**
 *
 * @author markcusrichardson
 */
public class OperatorMenuPassword extends javax.swing.JFrame {

    /**
     * Creates new form OperatorMenuPassword
     */
    public OperatorMenuPassword() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("The operator menu requires a password ");
    ...
    private void jPasswordField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jPasswordField1ActionPerformed
        // Code to check password and deny or allow acces to operator menu
        
        
        String input = jPasswordField1.getText();
        String password = new String(input);
        
        if (password.equals("Panda123")){
        ...
        jTextField1.setText("Incorrect password");
        }// End else statement
       
    }//GEN-LAST:event_jPasswordField1ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // Code to close password window
        this.dispose();
