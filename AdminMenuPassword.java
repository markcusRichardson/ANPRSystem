 ...
 */
import anpr.system.program.AdminMenu;


public class AdminMenuPassword extends javax.swing.JFrame {

    
    public AdminMenuPassword() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("The admin menu requires a password");
    ...
    private void jPasswordField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jPasswordField1ActionPerformed
        // Code for checking the athenticity of the password
        
        
        String input = jPasswordField1.getText();
        String password = new String(input);
        
        if (password.equals("Carrot123")){
